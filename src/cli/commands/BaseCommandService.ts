...
export abstract class BaseCommandService {
  ...
  protected async establishSectionHeader(
    title: string,
    color: LCUColor = defaultChalkColor,
    ...
    if (showHeader) this.establishHeader();
  ...
  protected async inquir(questions: ReadonlyArray<Question> | string, options?: any, exitOnError: boolean = true, errMsg?: string) {
