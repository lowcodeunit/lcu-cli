...
var UpdateCommandService = /** @class */ (function (_super) {
                ...
                return [2 /*return*/, program
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 7:
                                    _a.sent();
                                    return [4 /*yield*/, this.upgradeLCUPackages()];
                                case 8:
                                    _a.sent();
    ...
    UpdateCommandService.prototype.upgradeLCUPackages = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var packageJSON, deps, devDeps, lcuValues, lcuUpgradeCommands, depsUpgradeCommands, devDepsUpgradeCommands, upgrade, proc;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    lcuValues = ['@lcu', '@lowcodeunit'];
                                    lcuUpgradeCommands = [];
                                    depsUpgradeCommands = Object.keys(deps).map(function (depKey) {
                                        var dep = deps[depKey];
                                        if (lcuValues.some(function (v) { return depKey.startsWith(v); }))
