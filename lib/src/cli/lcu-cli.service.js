...
var LowCodeUnityCLIService = /** @class */ (function () {
    ...
    //  API Methods
    LowCodeUnityCLIService.prototype.SetupCLI = function (commands) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        commands.forEach(function (command) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, command.Setup(this.program)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
