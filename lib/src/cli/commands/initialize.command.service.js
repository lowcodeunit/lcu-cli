...
var InitializeCommandService = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, program
                        ...
                        .option('-t|--temp-path <temp>', "The temporary files path to use (default: " + this.userHomePath + "\\smart-matrix\\lcu).")
                            ...
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    context = {
                                        ...
                                        tempPath: path_1.default.join(options.tempPath || this.userHomePath + "\\smart-matrix\\lcu")
                                    };
                                    _a.label = 3;
                                case 3:
                                    _a.trys.push([3, 6, , 7]);
                                    return [4 /*yield*/, this.establishTemplatesRepo(path_1.default.join(context.tempPath, 'repos', context.repo), context.repo)];
                                case 4:
                                    answers = _a.sent();
    ...
    InitializeCommandService.prototype.processTemplates = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var ora, lcuFile, template, lcuConfig;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ora = this.Ora.start('Started creation of LCU config file...');
                        return [4 /*yield*/, this.loadFile(path_1.default.join(context.tempPath, 'repos', context.repo, this.SysPath, 'lcu.json'))];
                    case 1:
                        lcuFile = _a.sent();
                        template = handlebars_1.default.compile(this.jsonCleanup(lcuFile));
