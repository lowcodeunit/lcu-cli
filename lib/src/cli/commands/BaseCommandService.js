...
var BaseCommandService = /** @class */ (function () {
    ...
    BaseCommandService.prototype.compileTemplatesInDirectory = function (source, target, context) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_extra_1.default.ensureDir(target)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fs_extra_1.default.readdir(source)];
                    case 2:
                        contents = _a.sent();
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, fs_extra_1.default.stat(srcPath)];
                                    case 1:
                                        srcStats = _a.sent();
                                    ...
                                    case 4:
                                        compiled = _a.sent();
                                        return [4 /*yield*/, fs_extra_1.default.writeFile(tgtPath, compiled)];
                                    case 5:
                                        _a.sent();
                                        _a.label = 6;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        lcuConfig = _a.sent();
                        templatesRepoPath = this.pathJoin(lcuConfig.environment.tempFiles, 'repos', lcuConfig.templates.repository);
    ...
    BaseCommandService.prototype.pathJoin = function () {
        ...
        return path_1.default.join.apply(path_1.default, paths).replace('{{userHomePath}}', this.userHomePath);
    };
    BaseCommandService.prototype.saveLCUConfig = function (lcuConfig) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_extra_1.default.writeJson('lcu.json', lcuConfig, { spaces: '\t' })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
