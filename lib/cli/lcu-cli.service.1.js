...
var LowCodeUnityCLIService = /** @class */ (function () {
    ...
    LowCodeUnityCLIService.prototype.SetupCLI = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.initCliCommand()];
                    case 1:
                        _a.sent();
    ...
    //  Helpers
    LowCodeUnityCLIService.prototype.initCliCommand = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // clear();
                this.logger.Headline("LCU-CLI");
                this.program
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                this.program
                    ...
                    .alias('init')
                    .description('Initialize an LCU project as "library" or "lcu".')
                    .action(function (type) {
                    _this.logger.Chalk().blue("==========** Running LCU Initialization **==========");
                    var ora = Ora('Initializing...').start();
                    setTimeout(function () {
                        ora.text = 'Initizlized';
                        setTimeout(function () {
                            ora.succeed();
                        }, 2500);
                    }, 2500);
