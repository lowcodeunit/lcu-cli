...
var SolutionCommandService = /** @class */ (function (_super) {
    __extends(SolutionCommandService, _super);
    //  Fields
    //  Properties
    //  Constructors
    function SolutionCommandService() {
        return _super.call(this) || this;
    }
    //  API Methods
    SolutionCommandService.prototype.Setup = function (program) {
                            ...
                            switch (_b.label) {
                                case 0:
                                    ...
                                    config = {
                                        ...
                                        tempPath: path_1.default.join(options.tempPath || this.userHomePath + "\\smart-matrix\\lcu-sln")
                                    };
                                    _a = config;
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, this.establishTemplates(path_1.default.join(config.tempPath, config.projectName, 'templates-repo'), config.repo).catch(function (err) {
                                            _this.Ora.fail("Issue establish templates");
                                            process.exit(1);
                                        })];
                                case 2:
                                    answers = _b.sent();
    ...
    //  Helpers
    SolutionCommandService.prototype.ensureProjectName = function (projectName) {
        return __awaiter(this, void 0, void 0, function () {
            var answs;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SolutionCommandService.prototype.establishTemplates = function (repoTempPath, repo) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    SolutionCommandService.prototype.loadTemplateOptions = function (rootPath) {
        return __awaiter(this, void 0, void 0, function () {
            var file;
            return __generator(this, function (_a) {
    ...
    SolutionCommandService.prototype.loadTemplateSetupQuestions = function (rootPath) {
        return __awaiter(this, void 0, void 0, function () {
            var file;
            return __generator(this, function (_a) {
    ...
    return SolutionCommandService;
}(BaseCommandService_1.BaseCommandService));
exports.SolutionCommandService = SolutionCommandService;
