...
var InitializeCommandService = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, program
                        ...
                        var context, repoTempPath, answers, err_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 4:
                                    _a.sent();
                                    answers = this.inquir(this.pathJoin(repoTempPath, 'initialize'));
                                    context = Object.assign(context, answers);
                                    return [4 /*yield*/, this.processTemplates(context, 'initialize')];
                                case 5:
                                    _a.sent();
    ...
    InitializeCommandService.prototype.processTemplates = function (context, subPath) {
        return __awaiter(this, void 0, void 0, function () {
