...
var ProjectCommandService = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, program
                        ...
                        var context, _a, lcuConfig, templateRepoPath, answers, err_1;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 5:
                                    lcuConfig = _b.sent();
                                    templateRepoPath = this.pathJoin(this.tempFiles, 'repos', lcuConfig.templates.repository, 'project');
    ...
    ProjectCommandService.prototype.processTemplateInquiries = function (templatesRepoPath, context) {
        return __awaiter(this, void 0, void 0, function () {
